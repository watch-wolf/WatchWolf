...
## Standard
The standard can be seen [here](https://github.com/watch-wolf/WatchWolf/Standard/Protocols.pdf). Also, you can see a full implementation example in [TODO](TODO).
