...
Doubles are 8-bytes floating-point numbers. They are represented following the \gls{IEEE-754}\footnote{This standard should be used by C and Java. \myworries{cite?}}.
...
\begin{figure}[H]
	...
	\begin{bytefield}[bitwidth=2.5em]{16}
		...
		\bitbox{4}{\hyperref[spigot-types:liquid]{liquid}} & 
			\bitbox{1}{\hyperref[spigot-types:conditional]{cond}} & \bitbox{1}{\hyperref[spigot-types:inverted]{inv}} &
			\bitbox{1}{\hyperref[spigot-types:powered]{pow}} & \bitbox{1}{\hyperref[spigot-types:stripped]{strp}} & \bitbox{1}{\hyperref[spigot-types:infested]{infst}} & \bitbox{1}{\hyperref[spigot-types:dead]{dead}} & \bitbox{1}{\hyperref[spigot-types:type]{sticky}} &
			\bitbox[lrt]{5}[bgcolor=lightgray]{} \\
		\bitbox[lr]{16}[bgcolor=lightgray]{} \\
		\bitbox[lr]{16}[bgcolor=lightgray]{reserved} \\
		\bitbox[lr]{16}[bgcolor=lightgray]{} \\
...
\myworries{... get combined JaCoCo binary files of all the servers that the current connection has started}
...
\begin{bytefield}{32}
	...
	\wordbox[lr]{1}{\hyperref[type:double]{coverage}} \\
	\bitbox[lrb]{16}{} & \bitbox[ltr]{16}{} \\
