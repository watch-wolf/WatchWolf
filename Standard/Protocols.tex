...
\subsection{System operations} \label{g:system}
\myworries{...}

\subsubsection{ACK request operation}
\myworries{... send it as soon as all queue completed}
...
\begin{figure}[H]
	...
	\end{bytefield}
	\caption{ACK request operation structure}
\end{figure}

\subsubsection{ACK operation}
\myworries{... response to...}
...
\begin{figure}[H]
	...
	\end{bytefield}
	\caption{ACK operation structure}
\end{figure}

\subsubsection{Wait for seconds operation}
\myworries{...}

\subsection{Performance operations} \label{g:performance}
\myworries{...}

\subsection{Coverage operations} \label{g:coverage}
\myworries{...}

\subsubsection{Get coverage operation}
...
\begin{figure}[H]
	...
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000100}} & \bitbox{16}{\hyperref[s:server-operation]{0x0001}}
	\end{bytefield}
...
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b000000000100}} & \bitbox{16}{\hyperref[s:server-operation]{0x0001}} \\
