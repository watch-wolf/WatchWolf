...
\begin{subfigures}
	\begin{figure}
		\begin{rail}
			...
			([powered=false]() | [powered=true] 'POWERED\_') \\
			Material \\
	...
	\begin{figure}
		\begin{rail}
			...
			([(face undefined or face=wall) and (facing undefined or facing=north)]() | [face!=wall or facing!=north]('\_' ([face!=ceiling and facing!=up]() | [face=ceiling or facing=up]'U') \\ ([face!=floor and facing!=down]() | [face=floor or facing=down]'D') ([facing!=north]() | [facing=north]'N') \\ ([facing!=south]() | [facing=south]'S') ([facing!=east]() | [facing=east]'E') ([facing!=west]() | [facing=west]'W'))) \\
			'...'
		\end{rail}
		\label{rail:modifier-concatenation}
