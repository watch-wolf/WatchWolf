...
\section{Servers manager petition}
...
The response of \textit{Spawn entity operation} will be the \hyperref[type:entity]{UUID} assigned to that new entity.
...
\begin{table}[H]
	...
	\begin{tabular}{ |c|c|c| }
		...
		\hline
		\myworries{date} & 1 & Initial public release, \textit{v0.1.15}. \\
		\hline
	\end{tabular}
