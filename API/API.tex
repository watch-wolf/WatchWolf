...
\begin{figure}[H]
	...
	\begin{bytefield}{32}
		...
		\wordbox[lr]{1}{\hyperref[type:server-type]{server type}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{} \\
		...
		\skippedwords \\
		\wordbox[lrb]{1}{} \\
		\bitbox{8}{\hyperref[type:world-type]{world type}} & \bitbox[lrt]{24}{} \\
...
\subsubsection{World type}\label{type:world-type}
Minecraft can generate regular worlds, or superflat ones. Use this property to select the desired one.
...
\subsection{Get version operation}

Get the WatchWolf version of the servers manager.

\begin{figure}[H]
	\centering
	\begin{bytefield}{16}
		\bitheader{0,2,3,4,15} \\
		\bitbox{3}{\hyperref[s:dst]{0b000}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b111111111111}}
	\end{bytefield}
	\caption{Get version operation structure}
\end{figure}

\subsection{Get version response}

The response of \textit{Get version operation} will be the WatchWolf version.

\begin{figure}[H]
	\centering
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15} \\
		\bitbox{3}{\hyperref[s:dst]{0b000}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b111111111111}} & \bitbox[tlr]{16}{} \\
		\wordbox[lr]{1}{\hyperref[type:str]{version}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{}
	\end{bytefield}
	\caption{Get version response structure}
\end{figure}
...
\begin{table}[H]
	...
	\begin{tabular}{ |c|c|c| }
		...
		0 & 0b00000000010 & \hyperref[g:system]{Enhanced information operations} \\
...
\subsubsection{Change difficulty operation}
Change the server difficulty. You can set it to peaceful (0), easy (1), normal (2) and hard (3).

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000001}} & \bitbox{16}{\hyperref[s:server-operation]{0x0013}} \\
	\bitbox{16}{difficulty} & \bitbox[lr]{16}[bgcolor=lightgray]{}
\end{bytefield}
\caption{Change difficulty operation structure}
\end{figure}

\subsubsection{Set invulnerable mode operation}
Allows all players to be invincible from damage events like mobs hitting them, fall damage, burning... All except a player attacking another player.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000001}} & \bitbox{16}{\hyperref[s:server-operation]{0x0014}} \\
	\bitbox{8}{\hyperref[type:bool]{invulnerable}} & \bitbox[lr]{24}[bgcolor=lightgray]{}
\end{bytefield}
\caption{Set invulnerable mode operation structure}
\end{figure}

\subsubsection{Get version operation}
Get the WatchWolf version of the server.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000001}} & \bitbox{16}{\hyperref[s:server-operation]{0xFFFF}}
\end{bytefield}
\caption{Get version operation structure}
\end{figure}

\subsubsection{Get version response}
The response of \textit{Get version operation} will be the WatchWolf version.
...
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b000000000001}} & \bitbox{16}{\hyperref[s:server-operation]{0xFFFF}} \\
	\wordbox[lr]{1}{\hyperref[type:str]{version}} \\
	\skippedwords \\
	\wordbox[lrb]{1}{}
\end{bytefield}
...
\subsection{Enhanced information operations} \label{g:performance}
The \textit{enhanced information} operation provides extra data to be used while reviewing your plugin. Right now there's two type of extra information: a video of what's happening in the world (\hyperref[s:place-camera]{place camera}, \hyperref[s:move-camera]{move camera}, and \hyperref[s:stop-camera]{stop recording}), and getting the timings report\footnote{The ``timings report'' specifies what \% of the CPU is being used on each Minecraft command, so you can see performance problems by reviewing that report.} (\myworries{incomplete section}).

\myworries{This section is incomplete. Expect some future work here about measuring the performance of your plugins.}

\subsubsection{Place camera operation}\label{s:place-camera}
Places a camera in the target location and starts recording.

\begin{figure}[H]
	\centering
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000010}} & \bitbox{16}{\hyperref[s:server-operation]{0x0001}} \\
		\wordbox[lr]{1}{\hyperref[type:position]{position}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{} \\
		\wordbox[ltr]{1}{\hyperref[type:double]{pitch}\xfootnotemark} \\
		\wordbox[lrb]{1}{} \\
		\wordbox[ltr]{1}{\hyperref[type:double]{yaw}\xfootnotemark} \\
		\wordbox[lrb]{1}{} \\
	\end{bytefield}
	\caption{Place camera operation structure}
\end{figure}

\xfootnotetext{Minecraft's pitch is the vertical direction the user is looking at. It goes from 90 (down), to 0 (horizontal), to -90 (up).\label{foot:pitch}}

\xfootnotetext{Minecraft's yaw is the horizontal direction the user is looking at. A value of 0 means south, 90 west, $\pm$180 north, and -90 east.\label{foot:yaw}}

\subsubsection{Place camera response}
The response of \textit{Place camera operation} will be the ID of the placed camera.

\begin{figure}[H]
	\centering
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b000000000010}} & \bitbox{16}{\hyperref[s:server-operation]{0x0001}} \\
		\bitbox{16}{camera ID} & \bitbox[lr]{16}[bgcolor=lightgray]{}
	\end{bytefield}
	\caption{Place camera response structure}
\end{figure}

\subsubsection{Move camera operation}\label{s:move-camera}
Moves an already placed camera into the target location.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000010}} & \bitbox{16}{\hyperref[s:server-operation]{0x0002}} \\
	\bitbox{16}{camera ID} & \bitbox[lr]{16}{\hyperref[type:position]{position}} \\
	\wordbox[lr]{1}{} \\
	\skippedwords \\
	\wordbox[lrb]{1}{} \\
	\wordbox[ltr]{1}{\hyperref[type:double]{pitch}\textsuperscript{\ref{foot:pitch}}} \\
	\wordbox[lrb]{1}{} \\
	\wordbox[ltr]{1}{\hyperref[type:double]{yaw}\textsuperscript{\ref{foot:yaw}}} \\
	\wordbox[lrb]{1}{} \\
\end{bytefield}
\caption{Move camera operation structure}
\end{figure}

\subsubsection{Stop camera operation}\label{s:stop-camera}
Stops a camera and retrieves the recording.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000010}} & \bitbox{16}{\hyperref[s:server-operation]{0x0003}} \\
	\bitbox{16}{camera ID} & \bitbox[lr]{16}[bgcolor=lightgray]{}
\end{bytefield}
\caption{Stop camera operation structure}
\end{figure}

\subsubsection{Stop camera response}
The response of \textit{Stop camera operation} will be the recording.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b000000000010}} & \bitbox{16}{\hyperref[s:server-operation]{0x0003}} \\
	\wordbox[lr]{1}{\hyperref[type:file]{recording}} \\
	\skippedwords \\
	\wordbox[lrb]{1}{} \\
\end{bytefield}
\caption{Stop camera response structure}
\end{figure}


\subsubsection{Start timings report operation}
Starts the timings report.

\begin{figure}[H]
	\centering
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000010}} & \bitbox{16}{\hyperref[s:server-operation]{0x0004}}
	\end{bytefield}
	\caption{Start timings report operation structure}
\end{figure}

\subsubsection{Stop timings report operation}
Stops the timings report and retrieves \myworries{the raw file}.

\begin{figure}[H]
	\centering
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000010}} & \bitbox{16}{\hyperref[s:server-operation]{0x0005}}
	\end{bytefield}
	\caption{Stop timings report operation structure}
\end{figure}

\subsubsection{Stop timings report response}
The response of \textit{Stop timings operation} will be that report.

\begin{figure}[H]
	\centering
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b000000000010}} & \bitbox{16}{\hyperref[s:server-operation]{0x0005}} \\
		\wordbox[lr]{1}{\hyperref[type:file]{report}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{} \\
	\end{bytefield}
	\caption{Stop timings report response structure}
\end{figure}

\subsection{WorldGuard operations} \label{g:worldguard}
In this section you'll find some operations to interact with WorldGuard directly with the WatchWolf framework.

\myworries{Some more methods may be needed to fully support WorldGuard's functionalities. You can request them over the \href{https://discord.gg/PCD9MHRJ4W}{Discord}.}

\subsubsection{Create region operation}
...
\begin{figure}[H]
	...
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000011}} & \bitbox{16}{\hyperref[s:server-operation]{0x0001}} \\
		\wordbox[lr]{1}{\hyperref[type:str]{region name}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{} \\
		\wordbox[lr]{1}{\hyperref[type:position]{first coordinate}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{} \\
		\wordbox[lr]{1}{\hyperref[type:position]{second coordinate}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{} \\
	\end{bytefield}
	\caption{Create region operation structure}
\end{figure}

\subsubsection{Get regions operation}
Lists all the WorldGuard regions.

\begin{figure}[H]
	\centering
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000011}} & \bitbox{16}{\hyperref[s:server-operation]{0x0002}}
	\end{bytefield}
	\caption{Get regions operation structure}
\end{figure}

\subsubsection{Get regions response}
The response of \textit{Get regions operation}. You'll get the name of all the regions.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b000000000011}} & \bitbox{16}{\hyperref[s:server-operation]{0x0002}} \\
	\wordbox[lr]{1}{\hyperref[type:array]{array of region names}} \\
	\skippedwords \\
	\wordbox[lrb]{1}{} \\
\end{bytefield}
\caption{Get regions response structure}
\end{figure}

\subsubsection{Get regions at position operation}
Lists all the WorldGuard regions in one position.

WorldGuard allows multiple regions/sub-regions to overlap, so it may be possible to get more than one.

\begin{figure}[H]
	\centering
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b000000000011}} & \bitbox{16}{\hyperref[s:server-operation]{0x0003}} \\
		\wordbox[lr]{1}{\hyperref[type:position]{block}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{} \\
	\end{bytefield}
	\caption{Get regions at position operation structure}
\end{figure}

\subsubsection{Get regions at position response}
The response of \textit{Get regions at position operation}. You'll get the name of all the regions present in that block.

\begin{figure}[H]
	\centering
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15,16,31} \\
		\bitbox{3}{\hyperref[s:dst]{0b001}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b000000000011}} & \bitbox{16}{\hyperref[s:server-operation]{0x0003}} \\
		\wordbox[lr]{1}{\hyperref[type:array]{array of region names}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{} \\
	\end{bytefield}
	\caption{Get regions at position response structure}
\end{figure}
...
Get the WatchWolf version of the clients manager.

\begin{figure}[H]
	\centering
	\begin{bytefield}{16}
		\bitheader{0,2,3,4,15} \\
		\bitbox{3}{\hyperref[s:dst]{0b010}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b111111111111}}
	\end{bytefield}
	\caption{Get version operation structure}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15} \\
		\bitbox{3}{\hyperref[s:dst]{0b010}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b111111111111}} & \bitbox[tlr]{16}{} \\
		\wordbox[lr]{1}{\hyperref[type:str]{version}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{}
	\end{bytefield}
...
\begin{bytefield}{32}
	...
	\wordbox[lr]{1}{\hyperref[type:double]{pitch}\textsuperscript{\ref{foot:pitch}}} \\
	\skippedwords \\
	\wordbox[lrb]{1}{} \\
	\wordbox[lr]{1}{\hyperref[type:double]{yaw}\textsuperscript{\ref{foot:yaw}}} \\
	\skippedwords \\
	\wordbox[lrb]{1}{}
\end{bytefield}
\caption{Move at petition structure}
...
\subsection{Change fly status operation}
Only while in creative. Sets the fly status.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,23,24,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b011}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[s:operation]{0b000000001110}} & \bitbox{8}{\hyperref[type:bool]{is flying}} & \bitbox{8}[bgcolor=lightgray]{}
\end{bytefield}
\caption{Change fly status petition structure}
\end{figure}

\subsection{Start recording operation}
Start to record the client's actions.

\begin{figure}[H]
\centering
\begin{bytefield}{16}
	\bitheader{0,2,3,4,15} \\
	\bitbox{3}{\hyperref[s:dst]{0b011}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[s:operation]{0b000000001111}}
\end{bytefield}
\caption{Start recording petition structure}
\end{figure}

\subsection{Start recording response}
As a response of the \textit{Start recording operation}, you'll get the camera ID.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b011}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[s:operation]{0b000000001111}} & \bitbox{16}{camera ID}
\end{bytefield}
\caption{Start recording petition response structure}
\end{figure}

\subsection{Stop recording operation}
Stop recording the client's actions.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15} \\
	\bitbox{3}{\hyperref[s:dst]{0b011}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[s:operation]{0b000000010000}} & \bitbox{16}{camera ID}
\end{bytefield}
\caption{Stop recording petition structure}
\end{figure}

\subsection{Stop recording response}
As a response of the \textit{Start recording operation}, you'll get the recording.

\begin{figure}[H]
\centering
\begin{bytefield}{32}
	\bitheader{0,2,3,4,15,16,31} \\
	\bitbox{3}{\hyperref[s:dst]{0b011}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[s:operation]{0b000000010000}} & \bitbox[tlr]{16}{} \\
	\wordbox[lr]{1}{\hyperref[type:file]{recording}} \\
	\skippedwords \\
	\wordbox[lrb]{1}{} \\
\end{bytefield}
...
Get the WatchWolf version of the client.

\begin{figure}[H]
	\centering
	\begin{bytefield}{16}
		\bitheader{0,2,3,4,15} \\
		\bitbox{3}{\hyperref[s:dst]{0b011}} & \bitbox{1}{\hyperref[s:response]{0}} & \bitbox{12}{\hyperref[g:base]{0b111111111111}}
	\end{bytefield}
	\caption{Get version operation structure}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{bytefield}{32}
		\bitheader{0,2,3,4,15} \\
		\bitbox{3}{\hyperref[s:dst]{0b011}} & \bitbox{1}{\hyperref[s:response]{1}} & \bitbox{12}{\hyperref[g:base]{0b111111111111}} & \bitbox[tlr]{16}{} \\
		\wordbox[lr]{1}{\hyperref[type:str]{version}} \\
		\skippedwords \\
		\wordbox[lrb]{1}{}
	\end{bytefield}
...
\begin{table}[H]
	...
	\begin{tabular}{ |c|c|c|c| }
		...
		\hline
		03/06/2023 & 4 & v0.2.0 & Check version, specify world type, and set difficulty. \\
		\hline
		14/07/2023 & 5 & v0.2.0 & Added invulnerability mode. \\
		\hline
	\end{tabular}
